...
# Parámetros señal BUY — ruptura de resistencia con base sólida
BUY_RESISTANCE_WEEKS = 30   # semanas para calcular el nivel de resistencia (máximos)
BUY_MIN_BASE_WEEKS = 16     # semanas mínimas de base previa (MA30 plana)
